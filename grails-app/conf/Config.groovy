...
classDiagram {
    preferences {
        defaults {
            outputFormat = "svg"    // Should be an image format from http://www.graphviz.org/doc/info/output.html
        }
    }
}
...
grails.project.groupId = com.choranet.choraerp // change this to alter the default package name and Maven publishing destination
...
environments {
    production {
        grails.serverURL = "http://www.choraerp.com"
    }
    development {
...
log4j = {
    ...
    environments {
        production {
            appenders {
                rollingFile name: "choraerpAppender",
