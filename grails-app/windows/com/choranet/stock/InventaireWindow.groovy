...
class InventaireWindow extends SuperWindow {
    ...
    def isProduitPerissable(elementlInvCourant){
        def currentProdEstPerissable = false
        if (elementlInvCourant != null){        
            currentProdEstPerissable = Produit.findById(elementlInvCourant.produit.id).perissable
