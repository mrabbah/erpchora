...
import com.choranet.securite.Module
import com.choranet.compta.RegimeDeclarationTva
import org.apache.commons.lang.builder.* 

class ChoraClientInfo {
    ...
    boolean equals(final Object that) {         
        if(that == null || !(that instanceof ChoraClientInfo)) {
            return false
        }      
        return that.raisonSociale == raisonSociale            
    } 
