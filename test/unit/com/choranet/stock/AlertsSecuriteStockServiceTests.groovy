...
class AlertsSecuriteStockServiceTests extends GrailsUnitTestCase {
    ...
    void testGetListAlertsActives() {
       ...
       def testInstances9 = [new Partenaire(code : "005", raisonSociale : "celibataire", idFiscal : null,patente:"15165165",registreCommerce:"commerce",cnss:"fk13252152",adresse:"oulfa",codePostal:"20200",telephone:"0673327392",fax:"0632972654",email:"contact@choranet.com",siteWeb:"www.choranet.com",adresseFacturation:"hay el hana",adresseLivraison:"ain sebaii",estClient:new Boolean(true),estFournisseur:new Boolean(false),estParticulier:new Boolean(false),estBlacklist:new Boolean(false),plafond:new Double(12.12),modeRelancePaiement:testInstances2[0],modeReglementDefaut:testInstances3[0],echeance:testInstances4[0],ville:testInstances6[0],formeJuridique:testInstances7[0],modeLivraison:testInstances8[0],categoriePartenaires:testInstances1,solde:new Double(15.01),compteVerrouile:new Boolean(true),zone:testInstancesz[0],commercial:testInstancesee[0])]        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        ...
        def testService=new AlertsSecuriteStockService()
        testService.getListAlertsActives()
    }
    
     void testMettreAjourAlertSecuriteStockApresMouvement() {
         def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
       ...
       def testInstances9 = [new Partenaire(code : "005", raisonSociale : "celibataire", idFiscal : null,patente:"15165165",registreCommerce:"commerce",cnss:"fk13252152",adresse:"oulfa",codePostal:"20200",telephone:"0673327392",fax:"0632972654",email:"contact@choranet.com",siteWeb:"www.choranet.com",adresseFacturation:"hay el hana",adresseLivraison:"ain sebaii",estClient:new Boolean(true),estFournisseur:new Boolean(false),estParticulier:new Boolean(false),estBlacklist:new Boolean(false),plafond:new Double(12.12),modeRelancePaiement:testInstances2[0],modeReglementDefaut:testInstances3[0],echeance:testInstances4[0],ville:testInstances6[0],formeJuridique:testInstances7[0],modeLivraison:testInstances8[0],categoriePartenaires:testInstances1,solde:new Double(15.01),compteVerrouile:new Boolean(true),zone:testInstancesz[0],commercial:testInstancesee[0])]        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        ...
        def testInstancesst = [new Securitestock(stockMin : new Double(14.15), stockMax : new Double(14.15), stockReel : new Double(14.15),stockEntre:new Double(14.15),stockSortie:new Double(14.15),date_preremption:sqlDate1,entrepot:testInstances15[0],produit:testInstances20[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Securitestock, testInstancesst)
        def testInstancesa = [new AlertsSecuriteStock(dateAlerte :sqlDate1 , dateFinAlerte : sqlDate1, tjsValide : new Boolean(true),stockMin:new Double(12.15),stockMax:new Double(12.15),stockReel:new Double(12.15),details:"depassement du delai",raisonDeclanchement:testInstances66[0],raisonRelachement:testInstances66[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(AlertsSecuriteStock, testInstancesa)
        def myCriteria = [
    list : {Closure  cls -> return testInstancesa}
]
AlertsSecuriteStock.metaClass.static.createCriteria = { myCriteria }

        //def ProjetServiceControl = mockFor(ProjetService)
        
        def AlertsSecuriteStockServiceControl = mockFor(AlertsSecuriteStockService) 
        def testService=new AlertsSecuriteStockService()
        AlertsSecuriteStockServiceControl.demand.update(1..1) {it ->  }
        AlertsSecuriteStockServiceControl.demand.update(1..1) {it ->  }
        def d=testService.mettreAjourAlertSecuriteStockApresMouvement(testInstances66[0],testInstancesst[0],testInstancesst[0])
        System.out.println("hbhjbhjb   "+d)
    }
}
