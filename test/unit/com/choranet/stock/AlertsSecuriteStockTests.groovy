...
import java.text.*
class AlertsSecuriteStockTests extends GrailsUnitTestCase {
    ...
    void testAlertsSecuriteStockContraintes() {
        ...
        def testInstances3 = [new ModeReglement(code : "006", libelle : "espece1")]
       ...
       def testInstances9 = [new Partenaire(code : "005", raisonSociale : "celibataire", idFiscal : null,patente:"15165165",registreCommerce:"commerce",cnss:"fk13252152",adresse:"oulfa",codePostal:"20200",telephone:"0673327392",fax:"0632972654",email:"contact@choranet.com",siteWeb:"www.choranet.com",adresseFacturation:"hay el hana",adresseLivraison:"ain sebaii",estClient:new Boolean(true),estFournisseur:new Boolean(false),estParticulier:new Boolean(false),estBlacklist:new Boolean(false),plafond:new Double(12.12),modeRelancePaiement:testInstances2[0],modeReglementDefaut:testInstances3[0],echeance:testInstances4[0],ville:testInstances6[0],formeJuridique:testInstances7[0],modeLivraison:testInstances8[0],categoriePartenaires:testInstances1,solde:new Double(15.01),compteVerrouile:new Boolean(true),zone:testInstancesz[0],commercial:testInstancesee[0])]        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        ...
        assertEquals 1, AlertsSecuriteStock.count()
        assertTrue testInstancesa[0] instanceof AlertsSecuriteStock       
        def AlertsSecuriteStock2 = new AlertsSecuriteStock()
        assertFalse AlertsSecuriteStock2.validate()
        assertEquals "nullable", AlertsSecuriteStock2.errors["stockMin"]
        assertEquals "nullable", AlertsSecuriteStock2.errors["stockMax"]
        assertEquals "nullable", AlertsSecuriteStock2.errors["stockReel"]
        def AlertsSecuriteStock4 =  new AlertsSecuriteStock(dateAlerte :sqlDate1 , dateFinAlerte : sqlDate1, tjsValide : new Boolean(true),stockMin:new Double(12.15),stockMax:new Double(12.15),stockReel:new Double(12.15),details:"depassement du delai",raisonDeclanchement:testInstances66[0],raisonRelachement:testInstances66[0])
        assertTrue AlertsSecuriteStock4.validate()
        AlertsSecuriteStock4.save(flush:true)
        assertEquals 2, AlertsSecuriteStock.count()
        assertTrue AlertsSecuriteStock.get(AlertsSecuriteStock4.id) instanceof AlertsSecuriteStock
        assertNotNull AlertsSecuriteStock4.toString()
        System.out.println("cbcghgcghc"+AlertsSecuriteStock4.details.length())
        assertTrue AlertsSecuriteStock4.details.length() < 1000
    }
}
