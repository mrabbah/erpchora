...
class PaiementServiceTests extends GrailsUnitTestCase {
   ...
   void testUpdateCompteBancaireSociete(){
        ...
        //mockForConstraintsTests(DroitUtilisateur, testInstanc
     ...
     def testInstances9p = [new Partenaire(code : "005", raisonSociale : "celibataire", idFiscal : null,patente:"15165165",registreCommerce:"commerce",cnss:"fk13252152",adresse:"oulfa",codePostal:"20200",telephone:"0673327392",fax:"0632972654",email:"contact@choranet.com",siteWeb:"www.choranet.com",adresseFacturation:"hay el hana",adresseLivraison:"ain sebaii",estClient:new Boolean(true),estFournisseur:new Boolean(false),estParticulier:new Boolean(false),estBlacklist:new Boolean(false),plafond:new Double(12.12),modeRelancePaiement:testInstances2m[0],modeReglementDefaut:testInstances3m[0],echeance:testInstances4e[0],ville:testInstances6v[0],formeJuridique:testInstances7f[0],modeLivraison:testInstances8m[0],categoriePartenaires:testInstances1c,solde:new Double(15.01),compteVerrouile:new Boolean(true),zone:testInstancesz[0],commercial:testInstancesee[0])]        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        ...
        def testInstancescbc = [new CompteBancaireChoraClientInfo(libelle : "info", rib : "2115", codeSwift :"cs554",solde:new Double(15.02),soldePrevu:new Double(20.14),agenceBancaire:testInstancesab[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(CompteBancaireChoraClientInfo, testInstances)
        
        def testInstancespa = [new Paiement(numTransaction : "05554", date :sqlDate1 , montantPaye : new Double(100),dateEncaissement:sqlDate1,credit:new Boolean(true),statut:"ouvert",modeReglement:testInstances[0],compteBancairePartenaire:testInstancescb[0],compteBancaire:testInstancescbc[0],bonCommande:testInstancesbc[0],partenaire:testInstances9p[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Paiement, testInstancespa)
        def compteBancaireChoraClientInfoServiceControl = mockFor(CompteBancaireChoraClientInfoService)
        def testService=new PaiementService() 
        compteBancaireChoraClientInfoServiceControl.demand.update(1..1) {it -> return it }
        
        testService.compteBancaireChoraClientInfoService = compteBancaireChoraClientInfoServiceControl.createMock()
        testService.updateCompteBancaireSociete(testInstancescbc[0],new Double(12.04),sqlDate1,null,sqlDate1,"SAVE")
        
   }
    
    void testUpdateEtatPaiementBonCommande(){
     ...
     def testInstances9p = [new Partenaire(code : "005", raisonSociale : "celibataire", idFiscal : null,patente:"15165165",registreCommerce:"commerce",cnss:"fk13252152",adresse:"oulfa",codePostal:"20200",telephone:"0673327392",fax:"0632972654",email:"contact@choranet.com",siteWeb:"www.choranet.com",adresseFacturation:"hay el hana",adresseLivraison:"ain sebaii",estClient:new Boolean(true),estFournisseur:new Boolean(false),estParticulier:new Boolean(false),estBlacklist:new Boolean(false),plafond:new Double(12.12),modeRelancePaiement:testInstances2m[0],modeReglementDefaut:testInstances3m[0],echeance:testInstances4e[0],ville:testInstances6v[0],formeJuridique:testInstances7f[0],modeLivraison:testInstances8m[0],categoriePartenaires:testInstances1c,solde:new Double(15.01),compteVerrouile:new Boolean(true),zone:testInstancesz[0],commercial:testInstancesee[0])]        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        ...
        def testService=new PaiementService() 
        bonCommandeServiceControl.demand.update(1..1) {it -> return it }
        
        def myCriteria5 = [
    list : {Closure  cls -> return testInstancespa[0]}
]
Paiement.metaClass.static.createCriteria = { myCriteria5 }
        
        testService.bonCommandeService = bonCommandeServiceControl.createMock()
        testService.updateEtatPaiementBonCommande(testInstancesbc[0],false)
        
   }
   
    void testUpdateEtatPaiementBonCommandeAprsRetour(){
...
Paiement.metaClass.static.createCriteria = { myCriteria5 }
        ...
        testService.bonCommandeService = bonCommandeServiceControl.createMock()
        testService.updateEtatPaiementBonCommandeAprsRetour(testInstancesbc[0])
  ...
  void testSave(){
     ...
     def testInstances9p = [new Partenaire(code : "005", raisonSociale : "celibataire", idFiscal : null,patente:"15165165",registreCommerce:"commerce",cnss:"fk13252152",adresse:"oulfa",codePostal:"20200",telephone:"0673327392",fax:"0632972654",email:"contact@choranet.com",siteWeb:"www.choranet.com",adresseFacturation:"hay el hana",adresseLivraison:"ain sebaii",estClient:new Boolean(true),estFournisseur:new Boolean(false),estParticulier:new Boolean(false),estBlacklist:new Boolean(false),plafond:new Double(12.12),modeRelancePaiement:testInstances2m[0],modeReglementDefaut:testInstances3m[0],echeance:testInstances4e[0],ville:testInstances6v[0],formeJuridique:testInstances7f[0],modeLivraison:testInstances8m[0],categoriePartenaires:testInstances1c,solde:new Double(15.01),compteVerrouile:new Boolean(true),zone:testInstancesz[0],commercial:testInstancesee[0])]        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        ...
        def testInstancespa = [new Paiement(numTransaction : "05554", date :sqlDate1 , montantPaye : new Double(100),dateEncaissement:sqlDate1,credit:new Boolean(true),statut:"ouvert",modeReglement:testInstances[0],compteBancairePartenaire:testInstancescb[0],compteBancaire:null,bonCommande:testInstancesbc[0],partenaire:testInstances9p[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Paiement, testInstancespa)
        def bonCommandeServiceControl = mockFor(BonCommandeService)
        def testService=new PaiementService() 
...
Paiement.metaClass.static.createCriteria = { myCriteria5 }
        ...
        testService.bonCommandeService = bonCommandeServiceControl.createMock()
        testService.save(testInstancespa[0])   
    }  
    void testDelete(){
      def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
...
Paiement.metaClass.static.createCriteria = { myCriteria5 }
        ...
        testService.bonCommandeService = bonCommandeServiceControl.createMock()
        testService.delete(testInstancespa[0])   
    }  
    void testExisteDejaBonCommande(){
      def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Paiement.metaClass.static.createCriteria = { myCriteria5 }
        ...
        testService.bonCommandeService = bonCommandeServiceControl.createMock()
        testService.existeDejaBonCommande(testInstancesbc[0],testInstancesbc)   
    }  
    
     void testGetMontantPayeBonCommande(){
      def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Paiement.metaClass.static.createCriteria = { myCriteria5 }
        ...
        testService.bonCommandeService = bonCommandeServiceControl.createMock()
        testService.getMontantPayeBonCommande(testInstancesbc[0],true)   
    }  
    
    void testExisteDejaFacture(){
      def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Paiement.metaClass.static.createCriteria = { myCriteria5 }
        ...
        testService.bonCommandeService = bonCommandeServiceControl.createMock()
        testService.existeDejaFacture(testInstancesf[0],testInstancesf)   
    }  
    void testGetPaiementsFacture(){
      def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
     ...
     def testInstances9p = [new Partenaire(code : "005", raisonSociale : "celibataire", idFiscal : null,patente:"15165165",registreCommerce:"commerce",cnss:"fk13252152",adresse:"oulfa",codePostal:"20200",telephone:"0673327392",fax:"0632972654",email:"contact@choranet.com",siteWeb:"www.choranet.com",adresseFacturation:"hay el hana",adresseLivraison:"ain sebaii",estClient:new Boolean(true),estFournisseur:new Boolean(false),estParticulier:new Boolean(false),estBlacklist:new Boolean(false),plafond:new Double(12.12),modeRelancePaiement:testInstances2m[0],modeReglementDefaut:testInstances3m[0],echeance:testInstances4e[0],ville:testInstances6v[0],formeJuridique:testInstances7f[0],modeLivraison:testInstances8m[0],categoriePartenaires:testInstances1c,solde:new Double(15.01),compteVerrouile:new Boolean(true),zone:testInstancesz[0],commercial:testInstancesee[0])]        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        ...
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Paiement, testInstancespa)
        def testInstancesf = [new Facture(numeroFacture : "fa121511", type : "ACHAT", reference : "ref045224",date:sqlDate1,comptabilise:new Boolean(false),estAvoir:new Boolean(false),trans_totalht:new Double(13.02),trans_totaltva:new Double(13.02),trans_totalttc:new Double(13.02),trans_ligneProduits:testInstanceslp,faitgenerateur:"bilan",partenaire:testInstances9[0],paiements:testInstancespa,bonCommandes:testInstancesbc)]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Facture, testInstancesf)
        def bonCommandeServiceControl = mockFor(BonCommandeService)
        def testService=new PaiementService() 
...
Paiement.metaClass.static.createCriteria = { myCriteria5 }
        ...
        testService.bonCommandeService = bonCommandeServiceControl.createMock()
        testService.getPaiementsFacture(testInstancesf[0])   
    }  
    
    void testGetMontantPayeFacture(){
      def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Paiement.metaClass.static.createCriteria = { myCriteria5 }
        ...
        testService.getMontantPayeFacture(testInstancesf[0])   
    }  
    
    void testGetMontantNonPayeFacture(){
      def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Paiement.metaClass.static.createCriteria = { myCriteria5 }
        ...
        testService.getMontantNonPayeFacture(testInstancesf[0])   
    }  
    
    void testGetPaiementsBetwen(){
      def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Paiement.metaClass.static.createCriteria = { myCriteria5 }
        ...
        testService.bonCommandeService = bonCommandeServiceControl.createMock()
        testService.getPaiementsBetwen("ACHAT",sqlDate1,sqlDate1)   
    }  
     void testGetPaiementsByPartenaireBetwen(){
      def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Paiement.metaClass.static.createCriteria = { myCriteria5 }
        ...
        testService.bonCommandeService = bonCommandeServiceControl.createMock()
        testService.getPaiementsByPartenaireBetwen("ACHAT",testInstances9[0],sqlDate1,sqlDate1)   
    }  
     ...
     def testInstances9p = [new Partenaire(code : "005", raisonSociale : "celibataire", idFiscal : null,patente:"15165165",registreCommerce:"commerce",cnss:"fk13252152",adresse:"oulfa",codePostal:"20200",telephone:"0673327392",fax:"0632972654",email:"contact@choranet.com",siteWeb:"www.choranet.com",adresseFacturation:"hay el hana",adresseLivraison:"ain sebaii",estClient:new Boolean(true),estFournisseur:new Boolean(false),estParticulier:new Boolean(false),estBlacklist:new Boolean(false),plafond:new Double(12.12),modeRelancePaiement:testInstances2m[0],modeReglementDefaut:testInstances3m[0],echeance:testInstances4e[0],ville:testInstances6v[0],formeJuridique:testInstances7f[0],modeLivraison:testInstances8m[0],categoriePartenaires:testInstances1c,solde:new Double(15.01),compteVerrouile:new Boolean(true),zone:testInstancesz[0],commercial:testInstancesee[0])]        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        ...
        def testInstancespa = [new Paiement(numTransaction : "05554", date :sqlDate1 , montantPaye : new Double(100),dateEncaissement:sqlDate1,credit:new Boolean(false),statut:"ouvert",modeReglement:testInstances[0],compteBancairePartenaire:testInstancescb[0],compteBancaire:null,bonCommande:testInstancesbc[0],partenaire:testInstances9p[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Paiement, testInstancespa)
        def testInstancesf = [new Facture(numeroFacture : "fa121511", type : "ACHAT", reference : "ref045224",date:sqlDate1,comptabilise:new Boolean(false),estAvoir:new Boolean(false),trans_totalht:new Double(13.02),trans_totaltva:new Double(13.02),trans_totalttc:new Double(13.02),trans_ligneProduits:testInstanceslp,faitgenerateur:"bilan",partenaire:testInstances9[0],paiements:testInstancespa,bonCommandes:testInstancesbc)]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Facture, testInstancesf)
        //def PaiementControl = mockFor(PaiementService)
        def testService=new PaiementService() 
        //def h=PaiementControl.demand.getPaiements(1..1) {it -> return testInstancespa }
        def myCriteria5 = [
    list : {Closure  cls -> return testInstancespa}
]
Paiement.metaClass.static.createCriteria = { myCriteria5 }
        
        testService.getPaiements("ACHAT",true)   
        System.out.println("le changement  apres "+testInstancespa[0].credit)
    }  
    
    void testGetPaiementsPartenaireNonFacture(){
      def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
     ...
     def testInstances9p = [new Partenaire(code : "005", raisonSociale : "celibataire", idFiscal : null,patente:"15165165",registreCommerce:"commerce",cnss:"fk13252152",adresse:"oulfa",codePostal:"20200",telephone:"0673327392",fax:"0632972654",email:"contact@choranet.com",siteWeb:"www.choranet.com",adresseFacturation:"hay el hana",adresseLivraison:"ain sebaii",estClient:new Boolean(true),estFournisseur:new Boolean(false),estParticulier:new Boolean(false),estBlacklist:new Boolean(false),plafond:new Double(12.12),modeRelancePaiement:testInstances2m[0],modeReglementDefaut:testInstances3m[0],echeance:testInstances4e[0],ville:testInstances6v[0],formeJuridique:testInstances7f[0],modeLivraison:testInstances8m[0],categoriePartenaires:testInstances1c,solde:new Double(15.01),compteVerrouile:new Boolean(true),zone:testInstancesz[0],commercial:testInstancesee[0])]        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        ...
        bonCommandeServiceControl.demand.update(1..1) {it -> return it }
         def myCriteria4 = [
    list : {Closure  cls -> return testInstancesf}
]
Facture.metaClass.static.createCriteria = { myCriteria4 }
...
Paiement.metaClass.static.createCriteria = { myCriteria5 }
        ...
        testService.bonCommandeService = bonCommandeServiceControl.createMock()
        testService.getPaiementsPartenaireNonFacture("ACHAT",testInstances9[0],true)   
    }  
    
    void testConcatPaiementsNonFactureEtPaiementFacture(){
      def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Paiement.metaClass.static.createCriteria = { myCriteria5 }
        ...
        testService.bonCommandeService = bonCommandeServiceControl.createMock()
        testService.concatPaiementsNonFactureEtPaiementFacture("ACHAT",testInstancesf[0])   
    }  
    
    void testGetPaiementsByPartenaireEtType(){
      def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
     ...
     def testInstances9p = [new Partenaire(code : "005", raisonSociale : "celibataire", idFiscal : null,patente:"15165165",registreCommerce:"commerce",cnss:"fk13252152",adresse:"oulfa",codePostal:"20200",telephone:"0673327392",fax:"0632972654",email:"contact@choranet.com",siteWeb:"www.choranet.com",adresseFacturation:"hay el hana",adresseLivraison:"ain sebaii",estClient:new Boolean(true),estFournisseur:new Boolean(false),estParticulier:new Boolean(false),estBlacklist:new Boolean(false),plafond:new Double(12.12),modeRelancePaiement:testInstances2m[0],modeReglementDefaut:testInstances3m[0],echeance:testInstances4e[0],ville:testInstances6v[0],formeJuridique:testInstances7f[0],modeLivraison:testInstances8m[0],categoriePartenaires:testInstances1c,solde:new Double(15.01),compteVerrouile:new Boolean(true),zone:testInstancesz[0],commercial:testInstancesee[0])]        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        ...
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Paiement, testInstancespa)
        def testInstancesf = [new Facture(numeroFacture : "fa121511", type : "CREDIT", reference : "ref045224",date:sqlDate1,comptabilise:new Boolean(false),estAvoir:new Boolean(false),trans_totalht:new Double(13.02),trans_totaltva:new Double(13.02),trans_totalttc:new Double(13.02),trans_ligneProduits:testInstanceslp,faitgenerateur:"bilan",partenaire:testInstances9[0],paiements:testInstancespa,bonCommandes:testInstancesbc)]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Facture, testInstancesf)
        def bonCommandeServiceControl = mockFor(BonCommandeService)
        def testService=new PaiementService() 
...
Paiement.metaClass.static.createCriteria = { myCriteria5 }
        ...
        testService.bonCommandeService = bonCommandeServiceControl.createMock()
        testService.getPaiementsByPartenaireEtType(testInstances9[0],sqlDate1,sqlDate1,"CREDIT")   
    }  
    
//     void testGetPaiementsByType(){
//      def ex=new Integer(30032013)
//        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
//		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
// 
...
//        
//        testService.bonCommandeService = bonCommandeServiceControl.createMock()
//        testService.getPaiementsByType("ACHAT")   
//    }  
//    
    void testGetPaiementsByType(){
      def ex=new Integer(30032013)
...
Paiement.metaClass.static.createCriteria = { myCriteria5 }
        ...
        testService.bonCommandeService = bonCommandeServiceControl.createMock()
        testService.getPaiementsByType("CREDIT")   
    }  
