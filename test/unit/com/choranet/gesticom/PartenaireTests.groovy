...
import java.util.*
import java.text.*
class PartenaireTests extends GrailsUnitTestCase {
    ...
    void testPartenaireContraintes() {
        ...
        assertEquals 1, Partenaire.count()
        assertTrue testInstances9[0] instanceof Partenaire        
        def Partenaire2 = new Partenaire()
        assertFalse Partenaire2.validate()
        assertEquals "nullable", Partenaire2.errors["code"]
        assertEquals "nullable", Partenaire2.errors["raisonSociale"]
        def Partenaire3 = new Partenaire(code : "005", raisonSociale : "celibataire", idFiscal : null,patente:"15165165",registreCommerce:"commerce",cnss:"fk13252152",adresse:"oulfa",codePostal:"20200",telephone:"0673327392",fax:"0632972654",email:"contact@choranet.com",siteWeb:"www.choranet.com",adresseFacturation:"hay el hana",adresseLivraison:"ain sebaii",estClient:new Boolean(true),estFournisseur:new Boolean(false),estParticulier:new Boolean(false),estBlacklist:new Boolean(false),plafond:new Double(12.12),modeRelancePaiement:testInstances2[0],modeReglementDefaut:testInstances3[0],echeance:testInstances4[0],ville:testInstances6[0],formeJuridique:testInstances7[0],modeLivraison:testInstances8[0],categoriePartenaires:testInstances1,solde:new Double(15.01),compteVerrouile:new Boolean(true),zone:testInstancesz[0],commercial:testInstancese[0])
        assertFalse Partenaire3.validate()
        assertEquals "unique", Partenaire3.errors["code"]
        assertEquals "unique", Partenaire3.errors["raisonSociale"]
        def Partenaire4 = new Partenaire(code : "006", raisonSociale : "marie", idFiscal : null,patente:"15165165",registreCommerce:"commerce",cnss:"fk13252152",adresse:"oulfa",codePostal:"20200",telephone:"0673327392",fax:"0632972654",email:"contact@choranet.com",siteWeb:"www.choranet.com",adresseFacturation:"hay el hana",adresseLivraison:"ain sebaii",estClient:new Boolean(true),estFournisseur:new Boolean(false),estParticulier:new Boolean(false),estBlacklist:new Boolean(false),plafond:new Double(12.12),modeRelancePaiement:testInstances2[0],modeReglementDefaut:testInstances3[0],echeance:testInstances4[0],ville:testInstances6[0],formeJuridique:testInstances7[0],modeLivraison:testInstances8[0],categoriePartenaires:testInstances1,solde:new Double(15.01),compteVerrouile:new Boolean(true),zone:testInstancesz[0],commercial:testInstancese[0])
        assertTrue Partenaire4.validate()
        Partenaire4.save(flush:true)
        assertEquals 2, Partenaire.count()
        assertTrue Partenaire.get(Partenaire4.id) instanceof Partenaire
        assertEquals "marie", Partenaire4.toString()
    }
}
