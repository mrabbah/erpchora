...
class BonLivraisonTests extends GrailsUnitTestCase {
    ...
    void testBonLivraisonContraintes() {
        ...
        assertEquals 1, BonLivraison.count()
        assertTrue testInstancesbd[0] instanceof BonLivraison       
        def BonLivraison2 = new BonLivraison()
        assertFalse BonLivraison2.validate()
        assertEquals "nullable", BonLivraison2.errors["numBL"]
        assertEquals "nullable", BonLivraison2.errors["type"]
        assertEquals "nullable", BonLivraison2.errors["date"]
        assertEquals "nullable", BonLivraison2.errors["bonCommande"]
        assertEquals "nullable", BonLivraison2.errors["estLivre"]
        def BonLivraison3 = new BonLivraison(numBL : "XYZ", type : "ACHAT", reference : "5561",date:sqlDate1,trans_totalht:new Double(15.02),trans_totaltva:new Double(15.02),trans_totalttc:new Double(15.02),estBonRetour:new Boolean(true),estLivre:new Boolean(true),bonCommande:testInstances[0],ligneProduits:testInstanceslp)
        assertFalse BonLivraison3.validate()
        assertEquals "unique", BonLivraison3.errors["numBL"]
        def BonLivraison4 = new BonLivraison(numBL : "blXYZ", type : "ACHAT", reference : "5561",date:sqlDate1,trans_totalht:new Double(15.02),trans_totaltva:new Double(15.02),trans_totalttc:new Double(15.02),estBonRetour:new Boolean(true),estLivre:new Boolean(true),bonCommande:testInstances[0],ligneProduits:testInstanceslp)
        assertTrue BonLivraison4.validate()
        BonLivraison4.save(flush:true)
        assertEquals 2, BonLivraison.count()
        assertTrue BonLivraison.get(BonLivraison4.id) instanceof BonLivraison
        assertEquals "blXYZ", BonLivraison4.toString()
        
        def listype=["ACHAT","VENTE"]
        def iterator=(listype[0].equals(BonLivraison4.type)||listype[1].equals(BonLivraison4.type))
