...
import com.choranet.projet.MockRequestAttributes
...
class BonCommandeServiceTests extends GrailsUnitTestCase{
    ...
    def testService = new BonCommandeService()
    
     def resu=testService.getSequenceSuivante(testInstances[0])
    
    System.out.println("le resultat ncncbhcbg  "+resu)
        
    }
    void testGetBonCommandeNonLivree() {
        def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
       ...
       def testInstances9 = [new Partenaire(code : "005", raisonSociale : "celibataire", idFiscal : null,patente:"15165165",registreCommerce:"commerce",cnss:"fk13252152",adresse:"oulfa",codePostal:"20200",telephone:"0673327392",fax:"0632972654",email:"contact@choranet.com",siteWeb:"www.choranet.com",adresseFacturation:"hay el hana",adresseLivraison:"ain sebaii",estClient:new Boolean(true),estFournisseur:new Boolean(false),estParticulier:new Boolean(false),estBlacklist:new Boolean(false),plafond:new Double(12.12),modeRelancePaiement:testInstances2m[0],modeReglementDefaut:testInstances3m[0],echeance:testInstances4e[0],ville:testInstances6v[0],formeJuridique:testInstances7f[0],modeLivraison:testInstances8m[0],categoriePartenaires:testInstances1c,solde:new Double(15.01),compteVerrouile:new Boolean(true),zone:testInstancesz[0],commercial:testInstancesee[0])]        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        ...
        def testInstances = [new BonCommande(numBC : "bc001", type : "ACHAT", reference : "5561",date:sqlDate1,trans_totalht:new Double(14.12),trans_totaltva:new Double(14.12),trans_totalttc:new Double(14.12),totalttcRetour:new Double(0d),livree:new Boolean(false),paye:new Boolean(false),retourPaye:new Boolean(true),facture:new Boolean(false),bonPret:new Boolean(true),retournee:new Boolean(false),avecRetour:new Boolean(false),trans_livree:new Boolean(true),trans_retournee:new Boolean(true),partenaire:testInstances9p[0],utilisateur:testInstancesu[0],deviss:testInstancesd,ligneProduits:testInstanceslp),new BonCommande(numBC : "bc001", type : "ACHAT", reference : "5561",date:sqlDate1,trans_totalht:new Double(14.12),trans_totaltva:new Double(14.12),trans_totalttc:new Double(14.12),totalttcRetour:new Double(0d),livree:new Boolean(false),paye:new Boolean(false),retourPaye:new Boolean(true),facture:new Boolean(false),bonPret:new Boolean(true),retournee:new Boolean(false),avecRetour:new Boolean(false),trans_livree:new Boolean(true),trans_retournee:new Boolean(true),partenaire:testInstances9p[0],utilisateur:testInstancesu[0],deviss:testInstancesd,ligneProduits:testInstanceslp)]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(BonCommande, testInstances)
    def testService = new BonCommandeService()
...
BonCommande.metaClass.static.createCriteria = { myCriteria }
def ff = testService.getBonCommandeNonLivree("ACHAT") 
        
       System.out.println("hgghjghjg "+ff) 
       
    }
    
     void  testGetBonCommandePartenaireNonLivree() {
         def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
BonCommande.metaClass.static.createCriteria = { myCriteria }
def ff = testService.getBonCommandePartenaireNonLivree("ACHAT",testInstances9p[0]) 
        
       System.out.println("hgghjghjg "+ff)  
        
        
    }
    void testGetBonsCommande()
...
BonCommande.metaClass.static.createCriteria = { myCriteria }
def ff = testService.getBonsCommande("ACHAT") 
        
       System.out.println("getBonsCommande "+ff)  
        
        
    }
    void testGetBonsPret() {
...
BonCommande.metaClass.static.createCriteria = { myCriteria }
def ff = testService.getBonsPret("ACHAT") 
        
       System.out.println("getBonsPret "+ff)  
     ...
     void testGetBonCommandeNonRetournee() {
...
BonCommande.metaClass.static.createCriteria = { myCriteria }
def ff = testService.getBonCommandeNonRetournee("ACHAT") 
       ...
       void testGetBonCommandeBetwen() {
		...
		try {
			judDate1 = sdf_ddMMyyyy.parse("01/10/2005");
                        judDate3 = sdf_ddMMyyyy.parse("29/09/2005");
                        judDate2 = sdf_ddMMyyyy.parse("03/10/2005");
                        judDate4 = sdf_ddMMyyyy.parse("05/10/2005");
		} catch (ParseException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
...
BonCommande.metaClass.static.createCriteria = { myCriteria }
def ff = testService.getBonCommandeBetwen("ACHAT",sqlDate3,sqlDate4) 
    ...
    void testGetBonCommandeByPartenaireBetwen() {
...
BonCommande.metaClass.static.createCriteria = { myCriteria }
def ff = testService.getBonCommandeByPartenaireBetwen("ACHAT",testInstances9p[0],sqlDate3,sqlDate4) 
    ...
    void testGetBonCommandesNonPayePartenaire() {
...
BonCommande.metaClass.static.createCriteria = { myCriteria }
def ff = testService.getBonCommandesNonPayePartenaire(testInstances9p[0]) 
     ...
     void testGetBonCommandesNonPayePartenaire1() {
...
BonCommande.metaClass.static.createCriteria = { myCriteria }
def ff = testService.getBonCommandesNonPayePartenaire1(testInstances9p[0],"ACHAT") 
        
       System.out.println("getBonCommandesNonPayePartenaire "+ff)  
        
      
    }
    
    
     void testGetBonCommandeByPaiement() {
       ...
       def testInstances9 = [new Partenaire(code : "005", raisonSociale : "celibataire", idFiscal : null,patente:"15165165",registreCommerce:"commerce",cnss:"fk13252152",adresse:"oulfa",codePostal:"20200",telephone:"0673327392",fax:"0632972654",email:"contact@choranet.com",siteWeb:"www.choranet.com",adresseFacturation:"hay el hana",adresseLivraison:"ain sebaii",estClient:new Boolean(true),estFournisseur:new Boolean(false),estParticulier:new Boolean(false),estBlacklist:new Boolean(false),plafond:new Double(12.12),modeRelancePaiement:testInstances2m[0],modeReglementDefaut:testInstances3m[0],echeance:testInstances4e[0],ville:testInstances6v[0],formeJuridique:testInstances7f[0],modeLivraison:testInstances8m[0],categoriePartenaires:testInstances1c,solde:new Double(15.01),compteVerrouile:new Boolean(true),zone:testInstancesz[0],commercial:testInstancesee[0])]        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        ...
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(BonCommande, testInstances)
        def testInstancespa = [new Paiement(numTransaction : "05554", date :sqlDate1 , montantPaye : new Double(100),dateEncaissement:sqlDate1,credit:new Boolean(true),statut:"ouvert",modeReglement:testInstances3m[0],compteBancairePartenaire:null,compteBancaire:null,bonCommande:testInstances[0],partenaire:testInstances9p[0]),new Paiement(numTransaction : "05554", date :sqlDate1 , montantPaye : new Double(100),dateEncaissement:sqlDate1,credit:new Boolean(true),statut:"ouvert",modeReglement:testInstances3m[0],compteBancairePartenaire:null,compteBancaire:null,bonCommande:testInstances[0],partenaire:testInstances9p[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
...
BonCommande.metaClass.static.createCriteria = { myCriteria }
def ff = testService.getBonCommandeByPaiement(testInstancespa,"ACHAT") 
        
       System.out.println("getBonCommandeByPaiement "+ff)  
