...
class BonPretTests extends GrailsUnitTestCase {
    ...
    protected void tearDown() {
     ...
     def testInstances1c = [new CategoriePartenaire(libelle : "propr", categorieParente : null)]
        ...
        def testInstancesbp = [new BonPret(numBP : "bp001", type : "ACHAT", date : null,reference:"21561",montantGarantie:new Double(0d),trans_totalht:new Double(15.12),trans_totaltva:new Double(15.12),trans_totalttc:new Double(15.12),bonCommande:null,partenaire:testInstances9[0],utilisateur:testInstancesu[0],deviss:testInstancesd,ligneProduits:testInstanceslp)]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(BonPret, testInstancesbp)
        assertEquals 1, BonPret.count()
        assertTrue testInstancesbp[0] instanceof BonPret        
        def BonPret2 = new BonPret()
        assertFalse BonPret2.validate()
        assertEquals "nullable", BonPret2.errors["numBP"]
        assertEquals "nullable", BonPret2.errors["type"]
        assertEquals "nullable", BonPret2.errors["date"]
        assertEquals "nullable", BonPret2.errors["utilisateur"]
        def BonPret3 = new BonPret(numBP : "bp001", type : "ACHAT", date : null,reference:"21561",montantGarantie:new Double(0d),trans_totalht:new Double(15.12),trans_totaltva:new Double(15.12),trans_totalttc:new Double(15.12),bonCommande:null,partenaire:testInstances9[0],utilisateur:testInstancesu[0],deviss:testInstancesd,ligneProduits:testInstanceslp)
        assertFalse BonPret3.validate()
        assertEquals "unique", BonPret3.errors["numBP"]
        def BonPret4 = new BonPret(numBP : "bp002", type : "ACHAT", date : sqlDate1,reference:"21561",montantGarantie:new Double(0d),trans_totalht:new Double(15.12),trans_totaltva:new Double(15.12),trans_totalttc:new Double(15.12),bonCommande:null,partenaire:testInstances9p[0],utilisateur:testInstancesu[0],deviss:testInstancesd,ligneProduits:testInstanceslp)
        assertTrue BonPret4.validate()
        BonPret4.save(flush:true)
        assertEquals 2, BonPret.count()
        assertTrue BonPret.get(BonPret4.id) instanceof BonPret
        assertEquals "bp002", BonPret4.toString()
    }
}
