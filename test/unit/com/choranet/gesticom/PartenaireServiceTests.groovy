...
import java.text.*
class PartenaireServiceTests extends GrailsUnitTestCase {
    ...
    void testGetClients() {
        ...
        def testService=new PartenaireService()
        def o=testService.getClients()
        System.out.println("vvhjv   "+o+"    "+o.getClass())
    }
    
      void testGetFournisseursParticuliers() {
        def testInstances1 = [new CategoriePartenaire(libelle : "propr", categorieParente : null)]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(CategoriePartenaire, testInstances1)
        assertTrue testInstances1[0].validate()
        ...
        assertTrue testInstancese[0].validate()
        testInstancese[0].save(flush:true)
        def testInstances9 = [new Partenaire(code : "005", raisonSociale : "celibataire", idFiscal : null,patente:"15165165",registreCommerce:"commerce",cnss:"fk13252152",adresse:"oulfa",codePostal:"20200",telephone:"0673327392",fax:"0632972654",email:"contact@choranet.com",siteWeb:"www.choranet.com",adresseFacturation:"hay el hana",adresseLivraison:"ain sebaii",estClient:new Boolean(true),estFournisseur:new Boolean(true),estParticulier:new Boolean(true),estBlacklist:new Boolean(false),plafond:new Double(12.12),modeRelancePaiement:testInstances2[0],modeReglementDefaut:testInstances3[0],echeance:testInstances4[0],ville:testInstances6[0],formeJuridique:testInstances7[0],modeLivraison:testInstances8[0],categoriePartenaires:testInstances1,solde:new Double(15.01),compteVerrouile:new Boolean(true),zone:testInstancesz[0],commercial:testInstancese[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Partenaire, testInstances9)
        def testService=new PartenaireService()
        def o=testService.getFournisseursParticuliers()
        System.out.println("vvhjv   "+o+"    "+o.getClass())
    }
    
    void testGetClientsParticuliers() {
        def testInstances1 = [new CategoriePartenaire(libelle : "propr", categorieParente : null)]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(CategoriePartenaire, testInstances1)
        assertTrue testInstances1[0].validate()
        ...
        mockDomain(Partenaire, testInstances9)
        def testService=new PartenaireService()
        def o=testService.getClientsParticuliers()
        System.out.println("vvhjv   "+o+"    "+o.getClass())
    }
    void testGetParticuliers() {
        def testInstances1 = [new CategoriePartenaire(libelle : "propr", categorieParente : null)]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(CategoriePartenaire, testInstances1)
        assertTrue testInstances1[0].validate()
        ...
        mockDomain(Partenaire, testInstances9)
        def testService=new PartenaireService()
        def o=testService.getParticuliers()
        System.out.println("vvhjv   "+o+"    "+o.getClass())
    }
    void testGetFournisseurs() {
        ...
        mockDomain(Partenaire, testInstances9)
        def testService=new PartenaireService()
        def o=testService.getFournisseurs()
        System.out.println("vvhjv   "+o+"    "+o.getClass())
    }
     void testGetPartenaireParRaisonSociale() {
        def testInstances1 = [new CategoriePartenaire(libelle : "propr", categorieParente : null)]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(CategoriePartenaire, testInstances1)
        assertTrue testInstances1[0].validate()
        ...
        mockDomain(Partenaire, testInstances9)
        def testService=new PartenaireService()
        def o=testService.getPartenaireParRaisonSociale("celibataire")
        System.out.println("vvhjv   "+o+"    "+o.getClass())
    }
   void testGetBlackLists() {
        def testInstances1 = [new CategoriePartenaire(libelle : "propr", categorieParente : null)]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(CategoriePartenaire, testInstances1)
        assertTrue testInstances1[0].validate()
        ...
        assertTrue testInstancese[0].validate()
        testInstancese[0].save(flush:true)
        def testInstances9 = [new Partenaire(code : "005", raisonSociale : "celibataire", idFiscal : null,patente:"15165165",registreCommerce:"commerce",cnss:"fk13252152",adresse:"oulfa",codePostal:"20200",telephone:"0673327392",fax:"0632972654",email:"contact@choranet.com",siteWeb:"www.choranet.com",adresseFacturation:"hay el hana",adresseLivraison:"ain sebaii",estClient:new Boolean(true),estFournisseur:new Boolean(true),estParticulier:new Boolean(true),estBlacklist:new Boolean(true),plafond:new Double(12.12),modeRelancePaiement:testInstances2[0],modeReglementDefaut:testInstances3[0],echeance:testInstances4[0],ville:testInstances6[0],formeJuridique:testInstances7[0],modeLivraison:testInstances8[0],categoriePartenaires:testInstances1,solde:new Double(15.01),compteVerrouile:new Boolean(true),zone:testInstancesz[0],commercial:testInstancese[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Partenaire, testInstances9)
        def testService=new PartenaireService()
        def o=testService.getBlackLists()
        System.out.println("vvhjv   "+o+"    "+o.getClass())
    } 
    void testGetClientsNonBlacklist() {
        def testInstances1 = [new CategoriePartenaire(libelle : "propr", categorieParente : null)]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(CategoriePartenaire, testInstances1)
        assertTrue testInstances1[0].validate()
        ...
        def myCriteria = [
    list : {Closure  cls -> return testInstances9}
]
Partenaire.metaClass.static.createCriteria = { myCriteria }
        def o=testService.getClientsNonBlacklist()
        System.out.println("vvhjv   "+o+"    "+o.getClass())
    } 
    void testGetPartenairebyLivraison() {
        def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
        ...
        def testInstancesliv = [new Livraison(numExpedition : "l1555525",nbrColis  : new Integer(0), poidTotal : new Double(0d),frais:new Double(0d),date:sqlDate1,detail:"livraison a domicile",intituleVehicule:"hvjfh564564",immatriculation:"vgvg54654645",modeLivraison:testInstancesm[0],partenaire:testInstances9[0],bonLivraisons:testInstancesbd)]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Livraison, testInstancesliv)
        def testService=new PartenaireService()
        def o=testService.getPartenairebyLivraison(testInstancesliv[0])
        System.out.println("vvhjv   "+o+"    "+o.getClass())
    } 
}
