...
class LigneProduitServiceTests extends GrailsUnitTestCase {
    ...
    protected void tearDown() {
     ...
     void testGetProduitsQuantitesBonCommande() {
...
//        def testInstancesdev = [new AffectationProduitDTO(produit:testInstances20[0],quantite:new Double(15.12),total:new Double(15.12))]
//        //mockForConstraintsTests(DroitUtilisateur, testInstances)
//        mockDomain(AffectationProduitDTO, testInstancesdev)
//        assertTrue testInstancesdev[0].validate()
//        testInstancesdev[0].save(flush:true)
        ...
        def testService=new LigneProduitService()
        def myCriteria = [
    list : {Closure  cls -> return testInstanceslp}
]
LigneProduit.metaClass.static.createCriteria = { myCriteria }
//        testService.getProduitsQuantitesBonCommande(testInstances[0])
