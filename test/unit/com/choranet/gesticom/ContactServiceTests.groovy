...
class ContactServiceTests extends GrailsUnitTestCase {
    ...
    protected void tearDown() {
     ...
     void testGetContactPartenaire(){
        ...
        def testService=new ContactService()
        def myCriteria = [
    list : {Closure  cls -> return testInstancesc}
]
Contact.metaClass.static.createCriteria = { myCriteria }
        
        testService.getContactPartenaire(testInstances9[0])
