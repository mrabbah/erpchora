...
class TacheTests extends GrailsUnitTestCase {
...
//        testInstances[0].save(flush:true)
        ...
        def testInstancesph = [new Phase(dateDebutPrevue : sqlDate1, designation : "DROIT_XYZ", dateDebutRelle : sqlDate1,dateFinPrevue:sqlDate1,chargePrevue:new Double(12.02),dateFinReelle:sqlDate1,avancementPrevu:new Double(24.02),chargeRelle:new Double(24.02),avancementReel:new Double(24.02),projet:testInstancespj[0],documents:null)]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Phase, testInstancesph)
        assertTrue testInstancesph[0].validate()
        testInstancesph[0].save(flush:true)
        
        def testInstancestac = [new Tache(numero : new Integer(12), dateDebutPrevue : sqlDate1, designation : "developpement",dateDebutReelle:sqlDate1,dateFinPrevu:sqlDate1,chargePrevue:new Double(12.02),dateFinReelle:sqlDate1,avancementPrevu:new Double(12.02),chargeReelle:new Double(12.02),avancementReel:new Double(12.02),jalon:new Boolean(true),phase:testInstancesph[0],employe:null,predecesseur:null,documents:null)]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Tache, testInstancestac)
        assertEquals 1, Tache.count()
        assertTrue testInstancestac[0] instanceof Tache        
        def Tache2 = new Tache()
        assertFalse Tache2.validate()
        assertEquals "nullable", Tache2.errors["dateDebutPrevue"]
        assertEquals "nullable", Tache2.errors["designation"]
        assertEquals "nullable", Tache2.errors["dateDebutReelle"]
        assertEquals "nullable", Tache2.errors["dateFinPrevu"]
        assertEquals "nullable", Tache2.errors["dateFinReelle"]
        assertEquals "nullable", Tache2.errors["avancementPrevu"]
        assertEquals "nullable", Tache2.errors["chargeReelle"]    
         assertEquals "nullable", Tache2.errors["avancementReel"]
         assertEquals "nullable", Tache2.errors["jalon"]   
         assertEquals "nullable", Tache2.errors["phase"] 
        def Tache4 = new Tache(numero : new Integer(12), dateDebutPrevue : sqlDate1, designation : "developpement",dateDebutReelle:sqlDate1,dateFinPrevu:sqlDate1,chargePrevue:new Double(12.02),dateFinReelle:sqlDate1,avancementPrevu:new Double(12.02),chargeReelle:new Double(12.02),avancementReel:new Double(12.02),jalon:new Boolean(true),phase:testInstancesph[0],employe:null,predecesseur:null,documents:null)
        assertTrue Tache4.validate()
        Tache4.save(flush:true)
        assertEquals 2, Tache.count()
        assertTrue Tache.get(Tache4.id) instanceof Tache
        assertEquals "developpement", Tache4.toString()
    }
