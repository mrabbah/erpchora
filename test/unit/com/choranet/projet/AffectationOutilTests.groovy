...
class AffectationOutilTests extends GrailsUnitTestCase {
...
//        
        ...
        assertEquals 1, AffectationOutil.count()
        assertTrue testInstancesaf[0] instanceof AffectationOutil        
        def AffectationOutil2 = new AffectationOutil()
        assertFalse AffectationOutil2.validate()
        assertEquals "nullable", AffectationOutil2.errors["date"]
        assertEquals "nullable", AffectationOutil2.errors["coutHoraire"]
        assertEquals "nullable", AffectationOutil2.errors["outilEmploye"]
        assertEquals "nullable", AffectationOutil2.errors["projet"]
        assertEquals "nullable", AffectationOutil2.errors["employe"]
        def AffectationOutil4 = new AffectationOutil(date : sqlDate1, heuresEntretien	 : new Integer(12), heuresUtilisation : new Integer(21),coutHoraire:new Double(15.02),total:new Double(25.02),outilEmploye:testInstanceso[0],projet:testInstancespj[0],employe:testInstances[0])
        assertTrue AffectationOutil4.validate()
        AffectationOutil4.save(flush:true)
        assertEquals 2, AffectationOutil.count()
        assertTrue AffectationOutil.get(AffectationOutil4.id) instanceof AffectationOutil
        assertNotNull AffectationOutil4.toString()
    }
}
