...
import java.text.*
class SoustraitanceTests extends GrailsUnitTestCase {
  ...
  void testSoustraitanceContraintes() {
       def num=new Integer(12)
        def num1=new Integer(1)
        def testInstances = [new Soustraitant(numero : new Integer(2), nom : "trabel1", adresse : null,codePostal:null,ville:null,telephone:"0673327392",fax:null,email:null)]
...
//        testInstances[0].save(flush:true)
        ...
        def testInstancese = [new Employe(numero : num, nom : "allali", prenom : "youssef",telephone:"0673327392",tauxHoraire:new Double(12.13),salaire:new Double(12.13),calendrier:testInstances2c[0],fonction:testInstances3f[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        ...
        def testInstancesst = [new Soustraitance(date : sqlDate1, nom : "trabel", cout : new Double(15.12),soustraitant:testInstances[0],projet:testInstancespj[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Soustraitance, testInstancesst)
        assertEquals 1, Soustraitance.count()
        assertTrue testInstancesst[0] instanceof Soustraitance        
        def Soustraitance2 = new Soustraitance()
        assertFalse Soustraitance2.validate()
        assertEquals "nullable", Soustraitance2.errors["date"]
        assertEquals "nullable", Soustraitance2.errors["nom"]
        assertEquals "nullable", Soustraitance2.errors["cout"]
        assertEquals "nullable", Soustraitance2.errors["soustraitant"]
        assertEquals "nullable", Soustraitance2.errors["soustraitant"]
        def Soustraitance4 = new Soustraitance(date : sqlDate1, nom : "trabel", cout : new Double(15.12),soustraitant:testInstances[0],projet:testInstancespj[0])
        assertTrue Soustraitance4.validate()
        Soustraitance4.save(flush:true)
        assertEquals 2, Soustraitance.count()
        assertTrue Soustraitance.get(Soustraitance4.id) instanceof Soustraitance
        assertEquals "trabel", Soustraitance4.toString()
        assertTrue Soustraitance4.cout >= 0d
    }
}
