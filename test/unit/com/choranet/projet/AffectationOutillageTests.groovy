...
import java.text.*
class AffectationOutillageTests extends GrailsUnitTestCase {
    ...
    void testAffectationOutillageContraintes() {
        ...
        def testInstancesoc = [new OutillageCollectif(numero : new Integer(12), designation : "fabrication", dateAchat : sqlDate1,prixAchat:deb,dateMiseEnService:sqlDate2,dateFinUtilisation:sqlDate2)]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(OutillageCollectif, testInstancesoc)
        assertTrue testInstancesoc[0].validate()
        testInstancesoc[0].save(flush:true)
...
//        testInstances[0].save(flush:true)
        ...
        def testInstancesao1 = [new AffectationOutillage(dateAffectation : sqlDate1, dateFinUtilisationOutillage : sqlDate1, projet : testInstancespj[0],outillageCollectif:testInstancesoc[0],employe:testInstancese[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(AffectationOutillage, testInstancesao1)
        assertEquals 1, AffectationOutillage.count()
        assertTrue testInstancesao1[0] instanceof AffectationOutillage        
        def AffectationOutillage2 = new AffectationOutillage()
        assertFalse AffectationOutillage2.validate()
        assertEquals "nullable", AffectationOutillage2.errors["dateAffectation"]
        assertEquals "nullable", AffectationOutillage2.errors["projet"]
        assertEquals "nullable", AffectationOutillage2.errors["outillageCollectif"]
        assertEquals "nullable", AffectationOutillage2.errors["employe"]
        def AffectationOutillage4 = new AffectationOutillage(dateAffectation : sqlDate1, dateFinUtilisationOutillage : sqlDate1, projet : testInstancespj[0],outillageCollectif:testInstancesoc[0],employe:testInstancese[0])
        assertTrue AffectationOutillage4.validate()
        AffectationOutillage4.save(flush:true)
        assertEquals 2, AffectationOutillage.count()
        assertTrue AffectationOutillage.get(AffectationOutillage4.id) instanceof AffectationOutillage
        assertNotNull AffectationOutillage4.toString()
    }
}
