...
class ChargeDiversServiceTests extends GrailsUnitTestCase {
...
//        testInstances[0].save(flush:true)
        ...
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        def cha=new ChargeDivers(date : sqlDate1, nom : "construction1", cout : new Double(13.12),projet:testInstancespj[0])
        mockDomain(ChargeDivers,testInstancescd) 
        def testService=new ChargeDiversService()
        ...
        testService.save(testInstancescd[0])
    }
...
//        testInstances[0].save(flush:true)
        ...
        projetControl.demand.mettreAjourChargesReellesProjet(testInstancespj[0]) {login, pwd -> return  testInstancespj[0]}
        testService.projetService = projetControl.createMock()
        testService.delete(testInstancescd[0])
    }
}
