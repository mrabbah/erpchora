...
//        testInstances[0].save(flush:true)
        ...
        assertEquals 1, Phase.count()
        assertTrue testInstancesph[0] instanceof Phase        
        def Phase2 = new Phase()
        assertFalse Phase2.validate()
        assertEquals "nullable", Phase2.errors["dateDebutPrevue"]
        assertEquals "nullable", Phase2.errors["designation"]
        assertEquals "nullable", Phase2.errors["dateDebutRelle"]
        assertEquals "nullable", Phase2.errors["dateFinPrevue"]
        assertEquals "nullable", Phase2.errors["chargePrevue"]
        assertEquals "nullable", Phase2.errors["dateFinReelle"]
        assertEquals "nullable", Phase2.errors["avancementPrevu"]
        assertEquals "nullable", Phase2.errors["chargeRelle"]
        assertEquals "nullable", Phase2.errors["avancementReel"]
        assertEquals "nullable", Phase2.errors["projet"]
        def Phase4 = new Phase(dateDebutPrevue : sqlDate1, designation : "DROIT_XYZ1", dateDebutRelle : sqlDate1,dateFinPrevue:sqlDate1,chargePrevue:new Double(32.02),dateFinReelle:sqlDate1,avancementPrevu:new Double(24.02),chargeRelle:new Double(34.02),avancementReel:new Double(24.12),projet:testInstancespj[0],documents:null)
        assertTrue Phase4.validate()
        Phase4.save(flush:true)
        assertEquals 2, Phase.count()
        assertTrue Phase.get(Phase4.id) instanceof Phase
        assertEquals "DROIT_XYZ1", Phase4.toString()
    }
}
