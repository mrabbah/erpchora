...
import java.text.*
class ChargeDiversTests extends GrailsUnitTestCase {
   ...
   void testChargeDiversContraintes() {
...
//        testInstances[0].save(flush:true)
        ...
        assertEquals 1,ChargeDivers.count()
        assertTrue testInstancescd[0] instanceof ChargeDivers        
        def ChargeDivers2 = new ChargeDivers()
        assertFalse ChargeDivers2.validate()
        assertEquals "nullable", ChargeDivers2.errors["date"]
        assertEquals "nullable", ChargeDivers2.errors["nom"]
        assertEquals "nullable", ChargeDivers2.errors["cout"]
        assertEquals "nullable", ChargeDivers2.errors["projet"]
        def ChargeDivers4 = new ChargeDivers(date : sqlDate1, nom : "construction", cout : new Double(13.12),projet:testInstancespj[0])
        assertTrue ChargeDivers4.validate()
        ChargeDivers4.save(flush:true)
        assertEquals 2, ChargeDivers.count()
        assertTrue ChargeDivers.get(ChargeDivers4.id) instanceof ChargeDivers
        assertEquals "construction", ChargeDivers4.toString()
    }
}
