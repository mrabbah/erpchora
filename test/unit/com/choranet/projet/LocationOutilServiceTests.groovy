...
class LocationOutilServiceTests extends GrailsUnitTestCase {
...
//        testInstances[0].save(flush:true)
        ...
        def testService=new LocationOutilService()
        def projetControl = mockFor(ProjetService)
        //def superControl = mockFor(SuperService)
        //testService.update(1..1) {it -> return it }
        projetControl.demand.mettreAjourChargesReellesProjet(testInstancespj[0]) {login, pwd -> return  testInstancespj[0]}
        testService.projetService = projetControl.createMock()
        testService.save(testInstanceslo[0])
...
//        testInstances[0].save(flush:true)
        ...
        projetControl.demand.mettreAjourChargesReellesProjet(testInstancespj[0]) {login, pwd -> return  testInstancespj[0]}
        testService.projetService = projetControl.createMock()
        testService.delete(testInstanceslo[0])
