...
import java.text.*
class ProjetServiceTests extends GrailsUnitTestCase {
...
//        testInstances[0].save(flush:true)
        ...
        def testInstancese = [new Employe(numero : num, nom : "allali", prenom : "youssef",telephone:"0673327392",tauxHoraire:th,salaire:sa,calendrier:testInstances2c[0],fonction:testInstances3f[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        ...
        def testInstancespj = [new Projet(numero : new Integer(12), nom : "gestion commercial", dateDebutPrevu : null,dateDebutReelle:sqlDate1,dateFinPrevue:sqlDate1,dateFinReelle:null,chargePrevue:new Double(15.12),chargeReelle:new Double(15.12),avancementPrevu:new Double(15.12),avancementReel:new Double(15.12),adresseProjet:"ain sebaa",codePostal:"20200",ville:"casa",fax:"0673327392",telephone:"0673327392",email:"contact@choranet.com",nomContact:"pneumatique",montantBonCommande:new Integer(100),calendrier:testInstances2c[0],chefChantier:testInstancese[0], bonCommande:testInstancesbc[0],documents:testInstancesdn)]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Projet, testInstancespj)
        def testService=new ProjetService()
           def myCriteria = [
    list : {Closure  cls -> return testInstancespj}
]
Projet.metaClass.static.createCriteria = { myCriteria }
        testService.getProjetsTerminer()
        
    }
    
    void testGetProjetsNonTerminer() {
         def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Projet.metaClass.static.createCriteria = { myCriteria }
        testService.getProjetsNonTerminer()
        
    }
    
    void testGetProjetsNonTerminerCinqDerniers() {
         def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Projet.metaClass.static.createCriteria = { myCriteria }
        testService.getProjetsNonTerminerCinqDerniers()
        
    }
    
    void testGetProjetsCinqDerniers() {
         def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Projet.metaClass.static.createCriteria = { myCriteria }
        testService.getProjetsCinqDerniers()
        
    }
  
     void testMettreAjourChargesReellesProjet() {
         def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
//        testInstances[0].save(flush:true)
        ...
        assertTrue testInstancesbc[0].validate()
        testInstancesbc[0].save(flush:true)
        def testInstancesbd = [new BonLivraison(numBL : "XYZ", type : "ACHAT", reference : "5561",date:sqlDate1,trans_totalht:new Double(15.02),trans_totaltva:new Double(15.02),trans_totalttc:new Double(15.02),estBonRetour:new Boolean(true),estLivre:new Boolean(true),bonCommande:testInstancesbc[0],ligneProduits:testInstanceslp)]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        ...
        assertTrue testInstancesdn[0].validate()
        testInstancesdn[0].save(flush:true)
        def testInstancesemp = [new Employe(numero : num, nom : "allali", prenom : "youssef",telephone:"0673327392",tauxHoraire:th,salaire:sa,calendrier:testInstances2c[0],fonction:testInstances3f[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Employe, testInstancesemp)
        assertTrue testInstancesemp[0].validate()
        testInstancesemp[0].save(flush:true)
        
        def testInstanceso = [new OutilEmploye(numero : new Integer(15), nom : "gaterpillar", coutHoraire : new Double(15.13),employe:testInstancesemp[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        ...
        def testInstancesfp = [new FichePresence(date : sqlDate1, heuresPresence : new Double(14.02), heuresAbscence : new Double(14.02),dureeTrajet:new Double(14.02),tauxHoraire:new Double(14.02),heuresTravail:new Double(14.02),total:new Double(14.02),projet:testInstancespj[0],employe:testInstancesemp[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(FichePresence, testInstancesfp)
        ...
        def testInstancesaf = [new AffectationOutil(date : sqlDate1, heuresEntretien	 : new Integer(12), heuresUtilisation : new Integer(21),coutHoraire:new Double(15.02),total:new Double(25.02),outilEmploye:testInstanceso[0],projet:testInstancespj[0],employe:testInstancesemp[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(AffectationOutil, testInstancesaf)
        def testInstancescd = [new ChargeDivers(date : sqlDate1, nom : "construction", cout : new Double(13.12),projet:testInstancespj[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(ChargeDivers, testInstancescd)
        ...
        def testInstancesot = [new OutilLouable(designation : "fabrication", prixHeureLocation : new Double(500.05), loueur : testInstancesl[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(OutilLouable, testInstanceso)
        assertTrue testInstanceso[0].validate()
        testInstanceso[0].save(flush:true)
        def testInstanceslo = [new LocationOutil(date : sqlDate1, dureeLocation : new Integer(20), prixHeureLocation : new Double(12.15),prixForfait:new Double(12.15),total:new Double(15.02),loueur:testInstancesl[0],projet:testInstancespj[0],outilLouable:testInstancesot[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(LocationOutil, testInstanceslo)
        def testInstancessou = [new Soustraitant(numero : num, nom : "trabel", adresse : "rue 26 n°51 ain sebaa",codePostal:"20200",ville:"casa",telephone:"0673327392",fax:"0673327392",email:"wwww.choranet.com")]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Soustraitant, testInstances)
        def testInstancesst = [new Soustraitance(date : sqlDate1, nom : "trabel", cout : new Double(15.12),soustraitant:testInstancessou[0],projet:testInstancespj[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(Soustraitance, testInstancesst)
          def myCriteria = [
    list : {Closure  cls -> return testInstancesap}
]
AffectationOutil.metaClass.static.createCriteria = { myCriteria }
def myCriteria1 = [
    list : {Closure  cls -> return testInstancesaf}
]
AffectationProduit.metaClass.static.createCriteria = { myCriteria1 }
def myCriteria2 = [
    list : {Closure  cls -> return testInstancesap}
]
ChargeDivers.metaClass.static.createCriteria = { myCriteria2 }
def myCriteria3 = [
    list : {Closure  cls -> return testInstancescd}
]
FichePresence.metaClass.static.createCriteria = { myCriteria3 }

        def myCriteria4 = [
    list : {Closure  cls -> return testInstancescd}
]
FichePresence.metaClass.static.createCriteria = { myCriteria4 }
def myCriteria5 = [
    list : {Closure  cls -> return testInstanceslo}
]
LocationOutil.metaClass.static.createCriteria = { myCriteria5 }
def myCriteria6 = [
    list : {Closure  cls -> return testInstancesst}
]
Soustraitance.metaClass.static.createCriteria = { myCriteria6 }

 def ProjetServiceControl = mockFor(ProjetService)
        def testService=new ProjetService() 
        ProjetServiceControl.demand.update(1..1) {it ->  }
        testService.mettreAjourChargesReellesProjet(testInstancespj[0])
        
    }
    void testGetChargesAffectationOutil() {
         def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Soustraitance.metaClass.static.createCriteria = { myCriteria6 }
 //def f = new Foo(name:'jp')
    testInstancespj[0].metaClass.log = [error:{}]
        testService.getChargesAffectationOutil(testInstancespj[0])
    }
    void testGetSommeChargesAffectationOutil() {
         def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Soustraitance.metaClass.static.createCriteria = { myCriteria6 }
        testService.getSommeChargesAffectationOutil(testInstancespj[0])
    }
//    void testGetChargesAffectationProduit() {
//         def ex=new Integer(30032013)
//        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
//		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
// 
...
//        //mockForConstraintsTests(DroitUtilisateur, testInstances)
//        mockDomain(FichePresence, testInstancesfp)
//        def testInstancesap = [new AffectationProduit(date : sqlDate1, quantite : new Integer(12), prixUnitaire : new Double(15.12),total:new Double(15.12),bonLivraison:testInstancesbd[0],projet:testInstancespj[0],produit:testInstances20[0]),new AffectationProduit(date : sqlDate1, quantite : new Integer(12), prixUnitaire : new Double(15.12),total:new Double(15.12),bonLivraison:testInstancesbd[0],projet:testInstancespj[0],produit:testInstances20[0])]
//        //mockForConstraintsTests(DroitUtilisateur, testInstances)
//        mockDomain(AffectationProduit, testInstancesap)
//        def testInstancesaf = [new AffectationOutil(date : sqlDate1, heuresEntretien	 : new Integer(12), heuresUtilisation : new Integer(21),coutHoraire:new Double(15.02),total:new Double(25.02),outilEmploye:testInstanceso[0],projet:testInstancespj[0],employe:testInstancesemp[0])]
//        //mockForConstraintsTests(DroitUtilisateur, testInstances)
...
//        //mockForConstraintsTests(DroitUtilisateur, testInstances)
//        mockDomain(Soustraitance, testInstancesst)
//        def AffectationPr=[new AffectationProduitDTO(produit:testInstances20[0],quantite:new Double(15.03),total:new Double(20.02))]
//        //def ProjetServiceControl = mockFor(ProjetService)
//        def testService=new ProjetService()
//        def myCriteria1 = [
//        list : {Closure  cls -> return testInstancesap}
...
//       AffectationProduit.metaClass.static.createCriteria = { myCriteria1 }
//
//        testService.getChargesAffectationProduit(testInstancespj[0])
//    }
//    
    void testGetSommeChargesAffectationProduit() {
         def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Soustraitance.metaClass.static.createCriteria = { myCriteria6 }
        testService.getSommeChargesAffectationProduit(testInstancespj[0])
    }
    
    void testGetChargesChargeDivers() {
         def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Soustraitance.metaClass.static.createCriteria = { myCriteria6 }
        testService.getChargesChargeDivers(testInstancespj[0])
    }
     void testGetSommeChargesChargeDivers() {
         def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Soustraitance.metaClass.static.createCriteria = { myCriteria6 }
        testService.getSommeChargesChargeDivers(testInstancespj[0])
    }
//     void testGetChargesEmployes() {
//         def ex=new Integer(30032013)
//        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
//		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
// 
...
//]
//Soustraitance.metaClass.static.createCriteria = { myCriteria6 }
//        testService.getChargesEmployes(testInstancespj[0])
//    }
    void testGetSommeChargesEmployes() {
         def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Soustraitance.metaClass.static.createCriteria = { myCriteria6 }
        testService.getSommeChargesEmployes(testInstancespj[0])
    }
    
    void testGetChargesLocationOutil() {
         def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Soustraitance.metaClass.static.createCriteria = { myCriteria6 }
        testService.getChargesLocationOutil(testInstancespj[0])
    }
    
     void testGetSommeChargesLocationOutil() {
         def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Soustraitance.metaClass.static.createCriteria = { myCriteria6 }
        testService.getSommeChargesLocationOutil(testInstancespj[0])
    }
     void testGetChargesSoustraitance() {
         def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Soustraitance.metaClass.static.createCriteria = { myCriteria6 }
        testService.getChargesSoustraitance(testInstancespj[0])
    }
    
    void testGetSommeChargesSoustraitance() {
         def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
Soustraitance.metaClass.static.createCriteria = { myCriteria6 }
        testService.getSommeChargesSoustraitance(testInstancespj[0])
    }
}
