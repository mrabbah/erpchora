...
class AffectationOutillageServiceTests extends GrailsUnitTestCase {
    ...
    void testGetOutillageNonAffecter() {
...
//        testInstances[0].save(flush:true)
        ...
        def testService=new AffectationOutillageService()
        def myCriteria = [
    list : {Closure  cls -> return testInstancesoc}
]
OutillageCollectif.metaClass.static.createCriteria = { myCriteria }
def myCriteria1 = [
    list : {Closure  cls -> return testInstancesao1}
]
AffectationOutillage.metaClass.static.createCriteria = { myCriteria1 }
        testService.getOutillageNonAffecter()
        
    }
    
       void testGetOutillageAffecter() {
        def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
AffectationOutillage.metaClass.static.createCriteria = { myCriteria1 }
        testService.getOutillageAffecter()
