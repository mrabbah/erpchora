...
import java.text.*
class ProjetTests extends GrailsUnitTestCase {
...
//        testInstances[0].save(flush:true)
        ...
        assertEquals 1, Projet.count()
        assertTrue testInstancespj[0] instanceof Projet        
        def Projet2 = new Projet()
        assertFalse Projet2.validate()
        assertEquals "nullable", Projet2.errors["numero"]
        assertEquals "nullable", Projet2.errors["nom"]
        assertEquals "nullable", Projet2.errors["dateDebutReelle"]
        assertEquals "nullable", Projet2.errors["avancementReel"]
        assertEquals "nullable", Projet2.errors["montantBonCommande"]
        assertEquals "nullable", Projet2.errors["calendrier"]
        assertEquals "nullable", Projet2.errors["chefChantier"]
        def Projet4 = new Projet(numero : new Integer(12), nom : "gestion commercial", dateDebutPrevu : null,dateDebutReelle:sqlDate1,dateFinPrevue:sqlDate1,dateFinReelle:sqlDate1,chargePrevue:new Double(15.12),chargeReelle:new Double(15.12),avancementPrevu:new Double(15.12),avancementReel:new Double(15.12),adresseProjet:"ain sebaa",codePostal:"20200",ville:"casa",fax:"0673327392",telephone:"0673327392",email:"contact@choranet.com",nomContact:"pneumatique",montantBonCommande:new Integer(100),calendrier:testInstances[0],chefChantier:testInstancese[0], bonCommande:testInstancesbc[0],documents:testInstancesdn)
        assertTrue Projet4.validate()
        Projet4.save(flush:true)
        assertEquals 2, Projet.count()
        assertTrue Projet.get(Projet4.id) instanceof Projet
        assertEquals "gestion commercial", Projet4.toString()
        assertTrue  Projet4.numero >= 1
        assertTrue  Projet4.montantBonCommande >= 0d 
        assertTrue  Projet4.avancementReel >= 0d                           
        def d=Projet4.avancementReel.toString()
