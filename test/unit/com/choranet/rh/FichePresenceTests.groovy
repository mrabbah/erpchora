...
class FichePresenceTests extends GrailsUnitTestCase {
    ...
    void testFichePresenceContraintes() {
...
//        testInstances[0].save(flush:true)
        ...
        def testInstancesfp = [new FichePresence(date : sqlDate1, heuresPresence : new Double(14.02), heuresAbscence : new Double(14.02),dureeTrajet:new Double(14.02),tauxHoraire:new Double(14.02),heuresTravail:new Double(14.02),total:new Double(14.02),projet:testInstancespj[0],employe:testInstancese[0])]
        //mockForConstraintsTests(DroitUtilisateur, testInstances)
        mockDomain(FichePresence, testInstancesfp)
        assertEquals 1, FichePresence.count()
        assertTrue testInstancesfp[0] instanceof FichePresence        
        def FichePresence2 = new FichePresence()
        assertFalse FichePresence2.validate()
        assertEquals "nullable", FichePresence2.errors["date"]
        assertEquals "nullable", FichePresence2.errors["heuresPresence"]
        assertEquals "nullable", FichePresence2.errors["heuresAbscence"]
        assertEquals "nullable", FichePresence2.errors["dureeTrajet"]
        assertEquals "nullable", FichePresence2.errors["tauxHoraire"]
        assertEquals "nullable", FichePresence2.errors["projet"]
        assertEquals "nullable", FichePresence2.errors["employe"]
        def FichePresence4 = new FichePresence(date : sqlDate1, heuresPresence : new Double(14.02), heuresAbscence : new Double(14.02),dureeTrajet:new Double(14.02),tauxHoraire:new Double(14.02),heuresTravail:new Double(14.02),total:new Double(14.02),projet:testInstancespj[0],employe:testInstancese[0])
        assertTrue FichePresence4.validate()
        FichePresence4.save(flush:true)
        assertEquals 2, FichePresence.count()
        assertTrue FichePresence.get(FichePresence4.id) instanceof FichePresence
        assertNotNull  FichePresence4.toString()
        assertTrue FichePresence4.heuresPresence >= 0d
        assertTrue FichePresence4.heuresAbscence >= 0d
        assertTrue FichePresence4.dureeTrajet >= 0d
        assertTrue FichePresence4.tauxHoraire >= 0d
