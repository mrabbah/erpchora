...
class FichePresenceServiceTests extends GrailsUnitTestCase {
...
//        testInstances[0].save(flush:true)
        ...
        def testService=new FichePresenceService()
        ...
        testService.save(testInstancesfp[0])
    }
...
//        testInstances[0].save(flush:true)
        ...
        //projetServiceControl.demand.update(1..1) {it -> return it }
        testService.projetService = projetServiceControl.createMock()
        testService.delete(testInstancesfp[0])
    }
    
    void testGetNbHeuresTravilEmploye() {
          def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
//        testInstances[0].save(flush:true)
        ...
        def testService=new FichePresenceService()
        def myCriteria = [
    list : {Closure  cls -> return testInstancesfp}
]
FichePresence.metaClass.static.createCriteria = { myCriteria }
        testService.getNbHeuresTravilEmploye(testInstancese[0],sqlDate1,sqlDate1)
    }
    
     void testGetNbHeuresSuppEmploye() {
          def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
FichePresence.metaClass.static.createCriteria = { myCriteria }
        testService.getNbHeuresSuppEmploye(testInstancese[0],sqlDate1,sqlDate1)
    }
    
    void testGetNbJoursTravailEmploye() {
          def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
FichePresence.metaClass.static.createCriteria = { myCriteria }
        testService.getNbJoursTravailEmploye(testInstancese[0],sqlDate1,sqlDate1)
    }
   void testGetNbJoursAbscenceEmploye() {
          def ex=new Integer(30032013)
        final SimpleDateFormat sdf_yyyyMMdd = new SimpleDateFormat("yyyy-MM-dd");
		final SimpleDateFormat sdf_ddMMyyyy = new SimpleDateFormat("dd/MM/yyyy");
...
FichePresence.metaClass.static.createCriteria = { myCriteria }
        testService.getNbJoursAbscenceEmploye(testInstancese[0],sqlDate1,sqlDate1)
    }
